...
function PantryPosts(props) {
  ...
  const [updateModalToggle, setUpdateModalToggle] = React.useState(false);
  const [post, setPost] = React.useState("");
  const [postsList, setPostsList] = React.useState([]);
  const [pickedPostId, setPickedPostId] = React.useState();
  const { name } = props.location.state;
  const token = sessionStorage.getItem("token");
  const username = sessionStorage.getItem("name");
  const [location, setLocation] = React.useState("");
  const [hours, setTime] = React.useState("");
  const [id, setId] = React.useState("");
  const [pantryImg, setImage] = React.useState("");
